...
namespace mrs {
 ...
 void Robot::dejarVisible(bool visible) {
    // Asumiendo que 'm_settings' es accesible y tiene un miembro 'visible'
    m_settings.visible = visible;
    std::cout<<"visibilidad"<< m_settings.visible;
}
